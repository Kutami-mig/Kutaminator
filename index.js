function generateMsg() {
    ...
    switch (selectedOption?.id) {
        case "option1":
            finalMsg += `Der Artikel ${missingItem} (${quantityOfItems} Stück) ist aktuell nicht auf Lager. Dieser ist bereits beim Hersteller nachbestellt und 
            sollte in den nächsten Tagen eintreffen. Bei manchen Herstellern beträgt die Lieferzeit jedoch mehrere Wochen. Wenn Du deine Lieferung dringend benötigst, 
            schreib uns gerne eine Email.`;
            break;
        case "option2":
            finalMsg += `Der Artikel ${missingItem} (${quantityOfItems} Stück) ist aktuell nicht auf Lager. Dieser wird in den nächsten Tagen beim Hersteller 
            nachbestellt.`;
            ...
            if (extraOption1.checked) {
                finalMsg += `\nMöchtest Du den lieferbaren Rest deines Auftrages zugeschickt bekommen (Teillieferung)? Alternativ kannst Du dir einen anderen Artikel 
                aus unserem Sortiment aussuchen oder den fehlenden Artikel stornieren. Bitte schreibe uns dazu eine Email.`;
            }
            if (extraOption2.checked) {
                finalMsg += `\nMöchtest Du dir einen anderen Artikel aus unserem Sortiment aussuchen oder den fehlenden Artikel stornieren? Bitte schreibe uns 
                dazu eine Email.`;
            }
            break;
        case "option3":
            finalMsg += `Der Artikel ${missingItem} (${quantityOfItems} Stück) ist leider nicht auf Lager. Dieser wird beim Hersteller nicht mehr nachproduziert 
            oder wird bei uns in Zukunft nicht mehr lagernd sein. Daher werden wir den Artikel nicht nachbestellen bzw. nicht nachbestellen können. Bitte suche 
            dir einen anderen Artikel aus unserem Sortiment aus, alternativ kannst Du den Artikel stornieren.`;
            break;
        case "option4":
            finalMsg += `Aktuell fehlt uns der Straßenname / die Hausnummer, um dein Paket versenden zu können. Bitte schreibe uns eine Mail (Du kannst auf diese 
            Mail antworten) mit der Adresse, an die dein Paket versendet werden soll.`;
            break;
        case "option5":
        ...
        case "option7":
            ...
            Versand-Email erhalten. Wir legen dein Paket aber erst zum gewünschten Datum auf den Versandwagen.`;
            break;
        default:
